...
<x-card>
    ...
    <x-slot name="actions">
        <div class="flex items-center justify-between">
            <button wire:click="save" style="background-color:#AA6949;color:white"  class="btn btn-primary"> Save Service</button>
        </div>
    </x-slot>
    <x-slot name="body">
        <div class="">
                ...
                <div class="preview">
                    ...
                    <div>
                        ...
                        <input wire:model="name" id="regular-form-1" type="text" style="border-radius: 4px"
                            class="form-control @error('name') border-danger @enderror" placeholder="Name of Service" />
                        @error('name')
        ...
        @push('scripts')
            <script>
                ...
                window.addEventListener('serviceAdded', event => {
