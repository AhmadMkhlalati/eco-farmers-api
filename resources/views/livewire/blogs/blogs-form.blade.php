    ...
    <x-slot name="body">
            ...
            <div id="input" class="p-5">
                <div class="preview">
                    ...
                    <div class="mt-3">
                        ...
                        <input wire:model="title" id="regular-form-1" type="text" style="border-radius: 4px"
                            class="form-control" placeholder="Title of News" />
                        @error('title')
                    ...
                    <div class="mt-3">
                        <input wire:model="slug" disabled id="regular-form-1" type="text" class="form-control"
                            style="border-radius: 4px" placeholder="Slug of News" />
                        @error('slug')
                    ...
                    <div class="input-form mt-3">
                        ...
                        <textarea id="validation-form-6" class="form-control" wire:model="summary" placeholder="Enter Summary" minlength="10"
                            required=""></textarea>
                        @error('summary')
                    ...
                    <div class="mt-3" wire:ignore>
                        ...
                        <textarea id="textarea_editor" wire:model="description" rows="10" type="text" class="form-control mceEditor"
        ...
        @push('scripts')
            <script>
                ...
                window.addEventListener('blogAdded', event => {
