@props(['label' => false, 'type' => 'number', 'step' => '0.1'])
@if($label)
    <div class="form-group">
        ...
        <input id="{{$attributes['wire:model']}}"
               type="{{$type}}" step="{{$step}}"  {{$attributes->merge(['class' => 'border border-gray-200 focus:outline-none focus:ring-0 focus:border-gray-400 w-full'])}}>
