...
@php
    $isActiveClasses =  $isActive ? 'text-white  bg-blue-400 shadow-lg hover:bg-blue-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';

    $classes = 'flex-shrink-0 flex items-center gap-2 p-2 transition-colors rounded-md overflow-hidden dark:text-gray-400 ' . $isActiveClasses;
