...
{{--    <a href="{{ route('color-scheme-switcher', ['color_scheme' => 'theme-5']) }}" class="block w-8 h-8 cursor-pointer bg-basic rounded-full border-4 hover:border-slate-200 {{ $color_scheme =='theme-5' ? 'border-slate-300 dark:border-darkmode-800/80' : 'border-white dark:border-darkmode-600' }}"></a>--}}
{{--</div>--}}
{{--<!-- END: Main Color Switcher-->--}}
{{--<style>--}}
{{--    .bg-basic {--}}
{{--        background-color: rgb(41, 196, 204);--}}
{{--    }--}}
{{--</style>--}}
